...
int main(int argc, char*argv[]){
	...
	//-1 non visitée, 0 ya qqun dessus, val>0 à val cases de ma tete
	...
	while(returnCode == NORMAL_MOVE){
		...
		if(hePlays){
			...
			//parcours tableau de la fin jusqu'à la 2e valeur (ou 2e couple de valeurs)
			updateSnake(mySnake,longueur,myX,myY);
